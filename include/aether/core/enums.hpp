...
namespace aether::core {
    ...
    enum class solver : std::uint8_t {fog=0,plm=1,ppm=2,weno3=3,weno5=4,gp=6};
    enum class time_stepper : std::uint8_t {char_trace=0,rk1=1,rk2=2,rk3=3,rk4=4};
    enum class test_problem : std::uint8_t {sod=0,sedov=1,sr_shocktube=2,dmr=3, custom=4, load=5, sod_y=6, sod_z=7};
