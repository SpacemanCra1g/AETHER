...
namespace aether::core {
    enum class riemann : std::uint8_t {hll=0,hllc=1,roe=2,exact=3,tc=4};
    ...
    enum class test_problem : std::uint8_t {sod=0,sedov=1,sr_shocktube=2,dmr=3, custom=4, load=5, sod_y=6, sod_z=7, sod_contact=8};
    enum class boundary_conditions : std::uint8_t {Outflow = 1, Periodic = 2, Reflecting = 3,DoubleMachReflection=4};
