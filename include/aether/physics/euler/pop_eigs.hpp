...
namespace aether::physics::euler{
    ...
    static AETHER_INLINE void D1_X_EigenMatrix(        
        prims &p
    ...
    static AETHER_INLINE void D2_X_EigenMatrix(        
        prims &p
      , aether::core::one_cell_spectral_container &chars
      , const double gamma){
        const double a2 = p.p * gamma / p.rho;
    ...
    static AETHER_INLINE void D3_X_EigenMatrix(        
        prims &p
      , aether::core::one_cell_spectral_container &chars
      , const double gamma){
        const double a2 = p.p * gamma / p.rho;
    ...
    static AETHER_INLINE void D2_Y_EigenMatrix(        
        prims &p
      , aether::core::one_cell_spectral_container &chars
      , const double gamma){
            const double a2 = p.p * gamma / p.rho;
    ...
    static AETHER_INLINE void D3_Y_EigenMatrix(        
        prims &p
      , aether::core::one_cell_spectral_container &chars
      , const double gamma){
            const double a2 = p.p * gamma / p.rho;
    ...
    static AETHER_INLINE void D3_Z_EigenMatrix(        
        prims &p
      , aether::core::one_cell_spectral_container &chars
      , const double gamma){
            const double a2 = p.p * gamma / p.rho;
